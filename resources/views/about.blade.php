        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-5 col-lg-6 about-area-image wow animate__animated animate__fadeInLeft animate__delay-1s">
                    <img src="assets/images/banner/home_banner.png" alt="Habu">
                </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="member-bio">
                            <img src="assets/images/team-members/03_team-member-01.png" alt="Habu">
                            <h2>Jackson Nash</h2>
                            <h4>Programmer</h4>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="member-bio">
                            <img src="assets/images/team-members/03_team-member-02.png" alt="Habu">
                            <h2>John Harper</h2>
                            <h4>Web Developer</h4>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="member-bio">
                            <img src="assets/images/team-members/03_team-member-03.png" alt="Habu">
                            <h2>Jason Money</h2>
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6">
                        <div class="member-bio">
                            <img src="assets/images/team-members/03_team-member-04.png" alt="Habu">
                            <h2>Lady Cash</h2>
